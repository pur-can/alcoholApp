...
function _load_mkdirp() {return _mkdirp = _interopRequireDefault(require('mkdirp'));}var _fs;
function _load_fs() {return _fs = _interopRequireDefault(require('fs'));}var _buffered_console;
...
const createDirectory = path => {
  try {
    ...
    *
    * 
    */const realpath = filepath => {if (typeof (_fs || _load_fs()).default.realpathSync.native === 'function') {return (_fs || _load_fs()).default.realpathSync.native(filepath);} // $FlowFixMe: This is need for node@<9.2
